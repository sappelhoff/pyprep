...
print("Bad channels: {}"
      .format(prep.interpolated_channels))
print("Bad channels original: {}"
      .format(prep.noisy_channels_original['bad_all']))
print("Bad channels after interpolation: {}"
      .format(prep.still_noisy_channels))
